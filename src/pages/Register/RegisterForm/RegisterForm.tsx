      ...
      <form onSubmit={handleSubmit(onSubmit)} className="grid gap-y-5">
        ...
        <div className="grid gap-y-2">
          ...
          {errors.first_name && (
            <span
              role="alert"
              className={cn("text-sm", { "text-destructive": errors.first_name })}
            >
        ...
        <div className="grid gap-y-2">
          ...
          {errors.last_name && (
            <span
              role="alert"
              className={cn("text-sm", { "text-destructive": errors.last_name })}
            >
        ...
        <div className="grid gap-y-2">
          ...
          <Input
            ...
            className={cn("", { "border-destructive": errors.password_confirm })}
            {...register("password_confirm")}
          />
          {errors.password_confirm && (
            <span
              role="alert"
              className={cn("text-sm", { "text-destructive": errors.password_confirm })}
            >
